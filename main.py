...
#
#     return out_img
from run import plot_results, psnr, model, get_lowres_image, upscale_image
...
main(model,'data/data55873/images/test/14085.jpg')
# 7.模型保存
# > 将模型保存到 checkpoint/model_final ，并保留训练参数
model.save('checkpoint_80000photo_1epoch_32batSize/model_final',training=True)
